...
{-| -}
type RefreshControlSize
    = RefreshControlSizeRefreshLayoutConsts.SIZE.DEFAULT
    | RefreshControlSizeRefreshLayoutConsts.SIZE.LARGE


{-| -}
size : RefreshControlSize -> Property msg
size val =
    let
        stringValue =
            case val of
